...
{{--                            <div class="img"><img src="../res/img/sy_img1.jpg" alt=""></div>--}}
                        ...
                        <div class="layui-col-xs12 layui-col-sm8 layui-col-md7">
                            <div class="item-cont">
                                ...
                                <h3>{{$val->title}}<button class="layui-btn layui-btn-danger new-icon">new</button></h3>
                                <p>{{$val->content}}</p>
                                <a href="/show/{{$val->id}}" class="go-icon"></a>
                                    @endforeach
                            </div>
                        </div>
                    </div>
...
<footer style="text-align: center"><a href="http://www.beian.gov.cn/">赣ICP备20007132号</a></footer>
</div>
